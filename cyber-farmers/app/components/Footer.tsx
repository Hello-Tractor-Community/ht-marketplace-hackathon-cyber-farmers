        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 border-t border-gray-700 pt-4 flex flex-col sm:flex-row justify-between items-center text-sm">
            ...
            <div className="flex space-x-4">
              <a href="https://twitter.com/HelloTractor" target="_blank" rel="noopener noreferrer">
                <svg
              ...
              <svg
                  xmlns="https://www.linkedin.com/company/hello-tractor"
                  className="h-5 w-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <a href="https://www.instagram.com/hellotractor/" target="_blank" rel="noopener noreferrer">
              <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5"
                  fill="currentColor"
              ...
              <a href="https://www.facebook.com/hellotractor/" target="_blank" rel="noopener noreferrer">
              <svg
                  xmlns="ghttp://www.w3.org/2000/sv"
                  className="h-5 w-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
